...
def analyze_stock_news(news_text, stock_name):
    ...
    2. استخرج أهم 3 إلى 5 نقاط محورية تؤثر على سعر السهم، مع تجاهل الأخبار المكررة أو غير المهمة.
    3. حدد مستوى المخاطرة (عالي، متوسط، منخفض) مع توضيح السبب باختصار.
